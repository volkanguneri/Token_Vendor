...
const deployedContracts = {
  31337: {
    Vendor: {
      ...
      abi: [
        ...
        {
          inputs: [],
          name: "VendorHasInsufficientETHBalance",
          type: "error",
        },
        {
          anonymous: false,
  ...
  11155111: {
    Vendor: {
      address: "0x43fEA73B02B99c2FC9F72569590459e14c45856A",
      abi: [
        {
          inputs: [
            {
    ...
    YourToken: {
      address: "0xA0bf725CD211a246d3d59B009ce703137C7b95E1",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
